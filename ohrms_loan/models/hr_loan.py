...
class HrLoan(models.Model):
    ...
    is_desconto = fields.Boolean(string="E um desconto?", help="E um desconto diverso nao e empr'estimo")
...
class InstallmentLine(models.Model):
    ...
    def _onchange_paid(self):
        """Recalcula los montos del préstamo cuando se paga una cuota."""
        if self.loan_id:
