        ...
        _fetchFolhaDePagamento: function () {
            ...
            fetch(`/folhapagamento/data/${idToUse}`, {
                ...
                .then(data => {
                    ...
                    document.getElementById('departament').textContent = `Departamento: ${data.departamento_rh}`;
                    ...
                    if (data.aggregated_salary_rule_lines) {
                        ...
                        data.aggregated_salary_rule_lines.forEach(rule => {
                            ...
                            <td class="text-right text-nowrap">${rule.job_position}</td>
                            ...
                            <td class="text-right text-nowrap">${formatAsCurrency(rule.total_amount)}</td>
                `;
